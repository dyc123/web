...
['武汉','鄂州','恩施','黄冈','黄石','荆门','荆州','潜江','神农架','十堰','随州','天门','仙桃','咸宁','襄阳','襄樊','孝感','宜昌'],
...
var facitys=[
['杭州','湖州','嘉兴','金华','丽水','宁波','衢州','绍兴','台州','温州','舟山'],//浙江
//["深圳","广州","中山","东莞","惠州","佛山","珠海"],//广东
['广州','潮州','东莞','佛山','河源','惠州','江门','揭阳','茂名','梅州','清远','汕头','汕尾','韶关','深圳','阳江','云浮','湛江','肇庆','中山','珠海'],
["北京"],//北京
["上海"],//上海
["重庆"],//重庆
["天津"],//天津
['南京','常州','淮安','连云港','南通','苏州','宿迁','泰州','无锡','徐州','盐城','扬州','镇江'],//江苏
['福州','龙岩','南平','宁德','莆田','泉州','三明','厦门','漳州'],//福建
['武汉','恩施','黄冈','黄石','荆门','荆州','潜江','神农架','十堰','随州','天门','鄂州','仙桃','咸宁','襄樊','孝感','宜昌'],//湖北
['长沙','常德','郴州','衡阳','怀化','娄底','邵阳','湘潭','湘西','益阳','永州','岳阳','张家界','株洲'],//湖南
['成都','阿坝','巴中','达州','德阳','甘孜','广安','广元','乐山','凉山','泸州','眉山','绵阳','内江','南充','攀枝花','遂宁','雅安','宜宾','资阳','自贡'],//四川
['济南','滨州','德州','东营','菏泽','济宁','莱芜','聊城','临沂','青岛','日照','泰安','威海','潍坊','烟台','枣庄','淄博'],//山东
['郑州'],//河南
['石家庄','保定','沧州','承德','邯郸','衡水','廊坊','秦皇岛','唐山','邢台','张家口'],//河北
['沈阳','鞍山','本溪','朝阳','大连','丹东','抚顺','阜新','葫芦岛','锦州','辽阳','盘锦','铁岭','营口'],//辽宁
['合肥','安庆','蚌埠','亳州','巢湖','池州','滁州','阜阳','淮北','淮南','黄山','六安','马鞍山','宿州','铜陵','芜湖','宣城'],//安徽
['西安','安康','宝鸡','汉中','商洛','铜川','渭南','咸阳','延安','榆林'],//西安
['长春','白城','白山','吉林','辽源','四平','松原','通化','延边'],
...
function fagetCity()
{
  var sltProvince=document.getElementById("fa_province");
  var sltCity=document.getElementById("fa_city");
  sltCity.options.length=1;
  if(sltProvince.selectedIndex>0)
  {
    var provinceCity=facitys[sltProvince.selectedIndex-1];
    for(var i=0; i<provinceCity.length; i++)
    {
      var city=new Option(provinceCity[i],provinceCity[i]);
...
function shougetCity()
{

  var sltProvince=document.getElementById("shou_province");
  var sltCity=document.getElementById("shou_city");
  sltCity.options.length=1;
  if(sltProvince.selectedIndex>0)
  {
    var provinceCity=GT[sltProvince.selectedIndex-1];
    for(var i=0; i<provinceCity.length; i++)
    {
      var city=new Option(provinceCity[i],provinceCity[i]);
     sltCity.options.add(city);
